...
class EMA(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.buycomm = None
         ...
         # Add a Exponential Moving Average indicator
        self.ema = btind.ExponentialMovingAverage(self.data, period=self.p.period)
    ...
    def next(self):
        ...
        if not self.position:
            # if the close value is lower than the exponential moving average it is a buying opportunity
...
class MAcrossover(bt.Strategy): 
    ...
    def __init__(self):     
        ...
        self.fast_ema = btind.ExponentialMovingAverage(self.data, period=self.p.pfast)
        self.slow_ema = btind.ExponentialMovingAverage(self.data, period=self.p.pslow)
    ...
    def next(self):
        ...
        # Check for positions to close trade
            ...
            # else if it is a short position check for buying opportunity and close the postion
